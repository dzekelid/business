...
- name: Square Connect API Get a business's information.
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/business/master/_listings/square/v1me-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/business/master/_listings/square/v1me-get-openapi.md
- name: Square Connect API Provides summary information for all of a business's employees.
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/business/master/_listings/square/v1meemployees-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/business/master/_listings/square/v1meemployees-get-openapi.md
- name: Square Connect API Creates an employee for a business.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/business/master/_listings/square/v1meemployees-post-openapi.md
- name: Square Connect API Provides details for a business's locations, including
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/business/master/_listings/square/v1melocations-get-openapi.md
- name: Square Connect API Provides summary information for all of a business's employee
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/business/master/_listings/square/v1meroles-get-openapi.md
- name: Square Connect API Provides summary information for all of a business's employee
    timecards.
  x-api-slug: square-connect-api
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/business/master/_listings/square/v1metimecards-get-openapi.md
